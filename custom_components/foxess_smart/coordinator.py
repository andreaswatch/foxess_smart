...
class FoxESSUpdateCoordinator(DataUpdateCoordinator):
    ...
    def _poll_inverter(self) -> dict:
        ...
        _LOGGER.debug(
            "Raw Modbus registers: bms1=%s, bms2=%s, pv_vi=%s, grid_vi=%s, grid_ct=%s, load_p=%s, bat_p=%s, grid_p=%s, pv_p=%s, energy=%s, mode=%s",
            bms1, bms2, pv_vi, grid_vi, grid_ct, load_p, bat_p, grid_p, pv_p, energy, mode
        )
